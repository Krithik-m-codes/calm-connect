...
export default function Support() {
  return (
    <div className="pt-24 pb-20 px-[clamp(20px,6vw,80px)] min-h-[60vh] max-w-4xl mx-auto flex items-center justify-center">
      <SEOHead
        title="Support"
        description="Need the best help? Contact KalmKonnect for therapy session inquiries, scheduling, or emergency mental health support. Available Mon-Sat, 9 AM - 7 PM."
      />
      <motion.div
        initial="hidden"
        animate="visible"
      ...
      >
        ...
        <p className="text-brand-charcoal text-base lg:text-lg mb-8 max-w-2xl mx-auto">
          ...
          call your local emergency services immediately. For the best guidance
          on therapy sessions, scheduling, or other inquiries, please reach out
          to us.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          >
            Contact Us for Best Support
          </Button>
          <Button
            variant="whatsapp"
            className="w-full sm:w-auto py-3 px-8 text-lg"
          >
            WhatsApp Us for Best Support
          </Button>
        </div>
      </motion.div>
    </div>
